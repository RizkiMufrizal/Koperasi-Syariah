 ...
 * @Last Modified time: 2016-08-16 02:15:52
 */
-->
            	...
            	<div class="col-lg-12">
            		<form method="post" action="<?php echo base_url(); ?>index.php/UserController/updateUser">
            			...
            			<div class="form-group">
    						...
    						<input value="<?php echo $s->username; ?>" name="username" type="hidden" class="form-control" id="username" placeholder="masukkan username anda">
            			</div>
            			<div class="form-group">
            				<label for="password">Password</label>
    						<input value="<?php echo $s->password; ?>" name="password" type="password" class="form-control" id="password" placeholder="masukkan password anda">
            			</div>
            			<div class="form-group">
